...
作为一个程序猿， Blog 这种轮子要是挂在大众博客程序上就太没意思了。一是觉得大部分 Blog 都太丑，二是觉得不能随便定制不好玩。之前因为太懒没有折腾，结果就一直连个写 Blog 的地儿都没有。

本博客是用黄玄大佬的模板，[github仓库](https://github.com/Huxpro/huxpro.github.io)在这里，主要是为了将一些收获或是心得体会记录下来。
